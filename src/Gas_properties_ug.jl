...
"""
function ug_Carr_Kobayashi_Burrows(Ty::Union{Int64, Float64}, Psr::Union{Int64, Float64}, Tsr::Union{Int64, Float64}, M::Vector{<:Real}, fm::Vector{<:Real}, fm_nhc::Vector{<:Real})
...
#---------------------------------------------------------------------------------------------------------------------------------
function ug_Carr_Kobayashi_Burrows(Ty::Union{Int64, Float64}, Psr::Union{Int64, Float64}, Tsr::Union{Int64, Float64}, M::Vector{<:Real}, fm::Vector{<:Real}, fm_n2::Union{Int64, Float64}, fm_co2::Union{Int64, Float64}, fm_h2s::Union{Int64, Float64})
    a0, a1, a2, a3= -2.46211820, 2.97054714, -2.86264054e-1, 8.05420522e-3
    a4, a5, a6, a7 = 2.80860949, -3.49803305, 3.60373020e-1, -1.04432413e-2
    a8, a9, a10, a11 = -7.93385684e-1, 1.39643306, -1.49144925e-1, 4.41015512e-3
    a12, a13, a14, a15 = 8.39387178e-2, -1.86408848e-1, 2.03367881e-2, -6.09579263e-4
    ...
    C_co2 = fm_n2*(9.08e-3*log10(Ge) + 6.24e-3)
    C_h2s = fm_co2*(8.49e-3*log10(Ge) + 3.73e-3)
    C_n2 = fm_h2s*(8.48e-3*log10(Ge) + 9.59e-3)
    ug1c = ug1 + C_co2 + C_h2s + C_n2
...
\t ug -> Viscosidad del gas - (cp) {Float64} \n
"""
function ug_Lee_Gonzalez_Eakin(Py::Union{Int64, Float64}, Ty::Union{Int64, Float64}, z::Union{Int64, Float64}, M::Vector{<:Real}, fm::Vector{<:Real})
    Ty = Ty + 460
    Mm = sum(M .* fm)
