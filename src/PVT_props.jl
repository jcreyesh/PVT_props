...
export PTsc_Kay, PTsc_Stewart_Burkhardt_Voo, PTsc_Brown_Katz_Oberfell_Alden, PTsc_Sutton, PTsr_Wichert_Aziz, PTsc_Wichert_Aziz, PTsc_n2_h2o # 7
export z_Sarem, z_Papay, z_Hall_Yarborough, z_Beggs_Brill, z_Dranchuk_Purvis_Robinson, z_Dranchuk_Kassem, z_Gopal #7
export cg_Mattar_Brar_Aziz, cg_Sarem, cg_Papay, cg_Hall_Yarborough, cg_Beggs_Brill, cg_Gopal   # 6
export ug_Carr_Kobayashi_Burrows, ug_Lee_Gonzalez_Eakin   # 2

# Oil
export pb_Standing, pb_Lasater, pb_Vasquez_Beggs_sp, pb_Vasquez_Beggs, pb_Glaso, pb_Total_CFP, pb_AlMarhoun, pb_Dokla_Osman, # 8
       pb_Petrosky_Farshad, pb_Kartoatmodjo_Schmidt_sp, pb_Kartoatmodjo_Schmidt # 3

export rs_Standing, rs_Lasater, rs_Vasquez_Beggs_sp, rs_Vasquez_Beggs, rs_Glaso, rs_Total_CFP, rs_AlMarhoun, rs_Dokla_Osman, # 8
       rs_Petrosky_Farshad, rs_Kartoatmodjo_Schmidt_sp, rs_Kartoatmodjo_Schmidt # 3

export bo_Standing, bo_Vasquez_Beggs_sp, bo_Vasquez_Beggs, bo_Glaso, bo_Total_CFP, bo_AlMarhoun, bo_Dokla_Osman, 
       bo_Petrosky_Farshad, bo_Kartoatmodjo_Schmidt_sp, bo_Kartoatmodjo_Schmidt # 10
...
# Water
export rsw_Culberson_Mcketta, rsw_McCoy # 3

export bw_McCain, bw_McCoy # 2

export cwb_Dodson_Standing, cwb_Osif, cws_Ramey # 2
